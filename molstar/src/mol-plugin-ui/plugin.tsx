...
import { HorizontalToolbar } from '../zcustomized/ui/horizontal-toolbar/horizontal-toolbar';
...
export class DefaultViewport extends PluginUIComponent {
    render() {
        ...
        return <>
            <Viewport />
            <HorizontalToolbar />
            <div className='msp-viewport-top-left-controls' style={{top: '48%'}}>
            ...
            <VPControls wrapperStyle={{top: 'auto', bottom: '20%'}} />
